...
public partial class WwiseProjectDatabase
{
    ...
    public static async Task<bool> InitAsync(string inDirectoryPath, string inDirectoryPlatformName, string language)
    {
        ...
        await Task.Run(() => WwiseProjectDatabasePINVOKE_Windows.SetCurrentLanguage(language));
